...
export default async function page() {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-5 gap-x-10 gap-y-16 text-lg items-center px-6 md:px-10 xl:gap-x-24 xl:gap-y-32 max-w-screen-xl mx-auto">
      <div className="xl:col-span-3 md:col-span-2 space-y-8">
      ...
      <div className="xl:col-span-3 md:col-span-2 space-y-8">
        ...
        <div>
          <a
            href="/cabins"
            className="inline-block mt-4 bg-accent-500 px-8 py-4 text-primary-800 text-lg font-semibold hover:bg-accent-600 transition-all"
          >
